...
def save_output(image_name,pred,d_dir):
    # image_name 'C:\Users\梁伟城\Desktop\毕业设计\GANForCartoon-main\YOUR_DATASET_NAME_SEG\testA\\' pred (1,320,320) d_dir 'C:\Users\梁伟城\Desktop\毕业设计\GANForCartoon-main\YOUR_DATASET_NAME_SEG\testA\\'
...
def get_mask_FCN(face,img_name):
    prediction_dir = os.path.join(os.getcwd(), 'dataset', 'result_seg' , img_name)#'C:\Users\梁伟城\Desktop\毕业设计\GANForCartoon-main\YOUR_DATASET_NAME_SEG\testA\\'
    segment = FaceSeg()
...
def parse_opt():
    ...
    # 写在图片上的字
    parser.add_argument('--text-content',type=str,default='null',help='The words written on the cartoon picture')
    # 字的大小
